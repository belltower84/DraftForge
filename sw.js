const CACHE='draftforge-v8-13-row-results-20260826';
const ASSETS=['./','./index.html','./styles.css','./app.js','./engine.js','./sync.js','./vision.js','./data/players.js','./data/presets.js','./manifest.webmanifest'];
